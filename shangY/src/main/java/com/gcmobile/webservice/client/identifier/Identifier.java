package com.gcmobile.webservice.client.identifier;
...
import com.gcmobile.webservice.client.identifier.finance.CheckResponse;
import com.gcmobile.webservice.client.identifier.finance.Credential;
import com.gcmobile.webservice.client.identifier.finance.IdentifierData;
import com.gcmobile.webservice.client.identifier.finance.IsExistsResponse;
import com.gcmobile.webservice.client.identifier.finance.ModifyPwdRequest;
import com.gcmobile.webservice.client.identifier.nciic.IIdentifierService;
import com.gcmobile.webservice.client.identifier.nciic.IdentifierService;
...
public final class Identifier {
	...
	private static final com.gcmobile.webservice.client.identifier.finance.ObjectFactory financeObjectFactory = new com.gcmobile.webservice.client.identifier.finance.ObjectFactory();
	 ...
	 * @version 0.1 2014年8月14日
	 * @param checkRequest
	 * @return com.gcmobile.webservice.client.identifier.finance.CheckResponse
	 */
...
//		Thread.sleep(30 * 1000);
		...
		
		{
			...
			com.gcmobile.webservice.client.identifier.finance.IsExistsResponse _isSimpleCitizenExists__return = isSimpleCitizenExists(checkRequest);
...

		{
			...
			com.gcmobile.webservice.client.identifier.finance.IsExistsResponse _isExactCitizenExists__return = isExactCitizenExists(checkRequest);
		...
		
		{
			...
			com.gcmobile.webservice.client.identifier.finance.QueryUserResponse _queryUser__return = getIdentifierService().queryUser(credential);
		...
		
		{
			...
			com.gcmobile.webservice.client.identifier.finance.QueryHistoryRequest _querySimpleHistoryData_request = null;
			com.gcmobile.webservice.client.identifier.finance.QueryHistoryResponse _querySimpleHistoryData__return = getIdentifierService().querySimpleHistoryData(_querySimpleHistoryData_request, credential);
		...
		
		{
			...
			com.gcmobile.webservice.client.identifier.finance.BaseResponse _modifyPassword__return = getIdentifierService().modifyPassword(modifyPwdRequest, credential);
		...
		
		{
			...
			com.gcmobile.webservice.client.identifier.finance.QueryHistoryRequest _querySimpleHistoryDataCount_request = null;
			com.gcmobile.webservice.client.identifier.finance.QueryRecordCountResponse _querySimpleHistoryDataCount__return = getIdentifierService().querySimpleHistoryDataCount(_querySimpleHistoryDataCount_request, credential);
		...
		
		{
			...
			com.gcmobile.webservice.client.identifier.finance.QueryHistoryRequest _queryExactHistoryDataCount_request = null;
			com.gcmobile.webservice.client.identifier.finance.QueryRecordCountResponse _queryExactHistoryDataCount__return = getIdentifierService().queryExactHistoryDataCount(_queryExactHistoryDataCount_request, credential);
		...
		
		{
			...
			com.gcmobile.webservice.client.identifier.finance.BatchCheckRequest _batchExactCheck_request = null;
			com.gcmobile.webservice.client.identifier.finance.BatchCheckResponse _batchExactCheck__return = getIdentifierService().batchExactCheck(_batchExactCheck_request, credential);
		...
		
		{
			...
			com.gcmobile.webservice.client.identifier.finance.LoginUser _modifyUser_user = null;
			com.gcmobile.webservice.client.identifier.finance.BaseResponse _modifyUser__return = getIdentifierService().modifyUser(_modifyUser_user, credential);
		...
		
		{
			...
			com.gcmobile.webservice.client.identifier.finance.QueryUserRequest _queryAllUser_request = null;
			com.gcmobile.webservice.client.identifier.finance.QueryUserResponse _queryAllUser__return = getIdentifierService().queryAllUser(_queryAllUser_request, credential);
		...
		
		{
			...
			com.gcmobile.webservice.client.identifier.finance.LoginResponse _login__return = getIdentifierService().login(credential);
		...
		
		{
			...
			com.gcmobile.webservice.client.identifier.finance.AllocateFundRequest _allocateFund_request = null;
			com.gcmobile.webservice.client.identifier.finance.BaseResponse _allocateFund__return = getIdentifierService().allocateFund(_allocateFund_request, credential);
		...
		
		{
			...
			com.gcmobile.webservice.client.identifier.finance.QueryHistoryRequest _queryExactHistoryData_request = null;
			com.gcmobile.webservice.client.identifier.finance.QueryHistoryResponse _queryExactHistoryData__return = getIdentifierService().queryExactHistoryData(_queryExactHistoryData_request, credential);
		...
		
		{
			...
			com.gcmobile.webservice.client.identifier.finance.LoginUser _createUser_user = null;
			com.gcmobile.webservice.client.identifier.finance.BaseResponse _createUser__return = getIdentifierService().createUser(_createUser_user, credential);
