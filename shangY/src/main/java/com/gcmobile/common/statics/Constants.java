package com.gcmobile.common.statics;
...
public interface Constants {
	...
	Integer REALNAME_APPR_ISPASSED_REJECT = -1;
	Integer REALNAME_APPR_ISPASSED_NEVER = 0;
	Integer REALNAME_APPR_ISPASSED_APPLY = 2;
	Integer REALNAME_APPR_ISPASSED_WAIT_APPROVE = 3;
	Integer REALNAME_APPR_ISPASSED_PASSED = 1;
	...
	/***********活期宝投资方式 start**************/
	public static Integer TENDER_STYLE_MANUAL=1;//普通手动投资
	public static String TENDER_STYLE_MANUAL_NAME="活期投资";
	public static Integer TENDER_STYLE_REPEAT=2;//复投
	public static Integer TENDER_STYLE_SMALL=3;//零钱排队投资
	public static String TENDER_STYLE_SMALL_NAME="零钱转活期";
	public static Integer TENDER_STYLE_RETURNED=4;//提现失败资金退回
	/***********活期宝投资方式 end**************/
	
	/*********零钱转入方式 start******************/
	public static Integer CURLIL_IN_TENDER_TYPE_RECHARGE=1;//充值
	public static String CURLIL_IN_TENDER_TYPE_RECHARGE_NAME="投资零钱";
	public static Integer CURLIL_IN_TENDER_TYPE_RETURNED=2;//提现退回资金
	public static Integer CURLIL_IN_TENDER_TYPE_CURIN=3;//提现活期转零钱
	public static String CURLIL_IN_TENDER_TYPE_CURIN_NAME="提现";
	public static Integer CURLIL_IN_TENDER_TYPE_EXP=4;//体验金收益转零钱
	public static Integer CURLIL_IN_TENDER_TYPE_RED=5;//现金红包转零钱
	public static Integer CURLIL_IN_TENDER_TYPE_REC=6;//推荐投资返现转零钱
	public static String CURLIL_IN_TENDER_TYPE_NAME="奖励转零钱";
	public static String CURLIL_IN_TENDER_TYPE_RED_NAME="现金红包奖励";
	public static String CURLIL_IN_TENDER_TYPE_EXP_NAME="体验金收益";
	public static String CURLIL_IN_TENDER_TYPE_REC_NAME="推荐奖励";
	/***********零钱转入方式 end**************/
	
	/*********零钱转入业务类型 start******************/
	public static Integer CURLIL_IN_TARGET_TYPE_RECHARGE=1;//充值ID
	public static String CURLIL_IN_TARGET_NAME_RECHARGE="t_rechargerecord";
	public static Integer CURLIL_IN_TARGET_TYPE_RETURNED=2;//提现记录ID
	public static String CURLIL_IN_TARGET_NAME_RETURNED="t_cashrecord";
	public static Integer CURLIL_IN_TARGET_TYPE_CURIN=3;//活期转出记录ID
	public static String CURLIL_IN_TARGET_NAME_CURIN="t_cur_out";
	public static Integer CURLIL_IN_TARGET_TYPE_EXP=4;//
	public static String CURLIL_IN_TARGET_NAME_EXP="";
	public static Integer CURLIL_IN_TARGET_TYPE_RED=5;//
	public static String CURLIL_IN_TARGET_NAME_RED="";
	/***********零钱转入业务类型 end**************/
	
	/*********活期转出方式 start******************/
	public static Integer CUR_OUT_TARGET_TYPE_WITHDRAW=1;//提现
	/***********活期转出方式 end**************/
	
	/*********活期账户日志操作类型 start******************/
	public static Integer CUR_ACCOUNTLOG_TYPE_INTEREST=1;//活期生息
	public static Integer CUR_ACCOUNTLOG_TYPE_IN=2;//零钱转入
	public static Integer CUR_ACCOUNTLOG_TYPE_OUT=3;//转出到零钱
	public static Integer CUR_ACCOUNTLOG_TYPE_OPEN=4;//开户
	/***********活期账户日志操作类型end**************/
	
	/*********活期账户日志业务类型 start******************/
	public static Integer CUR_ACCOUNTLOG_TARGET_TYPE_CUR_IN=0;//0：t_cur_in ID
	public static String CUR_ACCOUNTLOG_TARGET_NAME_CUR_IN="t_cur_in";
	public static Integer CUR_ACCOUNTLOG_TARGET_TYPE_CUR_OUT=1;//1:t_cur_out ID
	public static String CUR_ACCOUNTLOG_TARGET_NAME_CUR_OUT="t_cur_out";
	public static Integer CUR_ACCOUNTLOG_TARGET_TYPE_CUR=2;//2：活期宝ID
	public static String CUR_ACCOUNTLOG_TARGET_NAME_CUR="t_cur";
	public static Integer CUR_ACCOUNTLOG_TARGET_TYPE_CURLIL_OUT=3;//3:t_curlil_out ID
	public static String CUR_ACCOUNTLOG_TARGET_NAME_CURLIL_OUT="t_curlil_out";
	public static Integer CUR_ACCOUNTLOG_TARGET_TYPE_INTEREST_DETAIL=4;//4:t_interest_detail ID
	public static String CUR_ACCOUNTLOG_TARGET_NAME_INTEREST_DETAIL="t_interest_detail";
	/***********活期账户日志业务类型end**************/
	
	/*********零钱账户日志业务类型 start******************/
	public static Integer CURLIL_ACCOUNTLOG_TARGET_TYPE_CURLIL_IN=0;//0：t_curlil_in
	public static String CURLIL_ACCOUNTLOG_TARGET_NAME_CURLIL_IN="t_curlil_in";
	public static Integer CURLIL_ACCOUNTLOG_TARGET_TYPE_CUR_OUT=1;//1:t_cur_out ID
	public static String CURLIL_ACCOUNTLOG_TARGET_NAME_CUR_OUT="t_cur_out";
	public static Integer CURLIL_ACCOUNTLOG_TARGET_TYPE_CUR=2;//2：活期宝ID
	public static String CURLIL_ACCOUNTLOG_TARGET_NAME_CUR="t_cur";
	public static Integer CURLIL_ACCOUNTLOG_TARGET_TYPE_CURLIL_OUT=3;//3:t_curlil_out ID
	public static String CURLIL_ACCOUNTLOG_TARGET_NAME_CURLIL_OUT="t_curlil_out";
	public static Integer CURLIL_ACCOUNTLOG_TARGET_TYPE_INTEREST_DETAIL=4;//3:t_interest_detail ID
	public static String CURLIL_ACCOUNTLOG_TARGET_NAME_INTEREST_DETAIL="t_interest_detail";
	/***********零钱账户日志业务类型end**************/
	
	/*********零钱账户日志操作类型 start******************/
	public static Integer CURLIL_ACCOUNTLOG_TYPE_INTEREST=1;//零钱生息
	public static Integer CURLIL_ACCOUNTLOG_TYPE_IN=2;//转入
	public static Integer CURLIL_ACCOUNTLOG_TYPE_OUT=3;//转出到活期宝
	public static Integer CURLIL_ACCOUNTLOG_TYPE_OPEN=4;//开户
	public static Integer CURLIL_ACCOUNTLOG_TYPE_CASH=5;//提现
	/***********零钱账户日志操作类型end**************/
	
	/*********活期转出方式 start******************/
	public static Integer CURLIL_OUT_TARGET_TYPE_WITHDRAW=1;//提现
	public static String CURLIL_OUT_TARGET_NAME_WITHDRAW="t_curlil_in";//提现
	public static Integer CURLIL_OUT_TARGET_TYPE_RECHARGE=2;//转出到活期宝
	public static String CURLIL_OUT_TARGET_NAME_RECHARGE="t_curlil_in";//转出到活期宝
	/***********活期转出方式 end**************/
	
	/*********提现记录日志类型 start******************/
	public static Integer CASHRECORD_LOG_TYPE_SUBMIT_AUDIT=0; //提交审核
	public static Integer CASHRECORD_LOG_TYPE_AUDIT_SUCCESS=1; //审核成功
	public static Integer CASHRECORD_LOG_TYPE_AUDIT_FAILED=2; //审核失败
	public static Integer CASHRECORD_LOG_TYPE_CANCEL_WITHDRAW=3; //取消提现
	public static Integer CASHRECORD_LOG_TYPE_INVALID_WITHDRAW=4; //提现作废
	public static Integer CASHRECORD_LOG_TYPE_PAY_FAILED=5; //打款失败
	public static Integer CASHRECORD_LOG_TYPE_PAY_SUCCESS=6; //打款成功
	/*********提现记录日志类型 end******************/
	
	/*********零钱排队业务类型start******************/
	public static Integer QUEUE_CURLIL_TARGET_TYPE_RECHARGE = 1; //充值
	public static String QUEUE_CURLIL_TARGET_NAME_RECHARGE = "t_rechargerecord";
	public static String QUEUE_CURLIL_TARGET_NAME_CURLILIN = "t_curlil_in";
	/*********零钱排队业务类型 end******************/
	 ...
	 * 产品类型[1-体验金,2-加息券]
	 */
	int PRODUCT_TYPE_EXP = 1;
	int PRODUCT_TYPE_FLOATCOUPON = 2;
	/**
	 * 产品分类[101-注册体验金,201-摇一摇加息券]
	 */
	int PRODUCT_TYPE_EXP_REG = 101;
	int PRODUCT_TYPE_EXP_YYY = 201;
	/**
	 * 产品状态[1-启用,2-不启用]
	 */
	int PRODUCT_STATUS_QIYONG = 1;
	int PRODUCT_STATUS_BUQIYONG = 2;
	/**************** 体验金状态 start *************/
	/**
	 * 状态【0：发放/未启用，1：启用/计息中，2：已退出/停止计息，3：已提取收益/转入零钱，-1：已过期】
	 */
	int EXP_STATUS_WEIQIYONG = 0;
	int EXP_STATUS_QIYONG = 1;
	int EXP_STATUS_EXIT = 2;
	int EXP_STATUS_YITIQU = 3;
	int EXP_STATUS_EXPIRE = -1;
	/**************** 体验金状态 end *************/
	/**************** 体验金类型 start *************/
	/**
	 * 状态 1-注册体验金 2-摇一摇体验金
	...
	/**************** 体验金类型 end *************/
	/**
	 * type暂时与target_Type一致,以后可能会发生变动
	 * 体验金账户日志type操作类型【1：开户，2：发放，3：计息，4：（本金）退出，5：（收益）提取 6:过期】
	 */
	int ACCOUNTLOG_TYPE_OPENACCOUNT = 1;
	int ACCOUNTLOG_TYPE_GIVE = 2;
	int ACCOUNTLOG_TYPE_GENERATE = 3;
	int ACCOUNTLOG_TYPE_EXIT = 4;
	int ACCOUNTLOG_TYPE_TAKE = 5;
	int ACCOUNTLOG_TYPE_EXPIRE = 6;
	/**************** 体验金type end *************/
	/**
	 * 体验金账户日志target_type操作类型【1：开户，2：发放，3：计息，4：（本金）退出，5：（收益）提取 6:过期】
	 */
	int ACCOUNTLOG_TARGET_TYPE_OPENACCOUNT = 1;
	int ACCOUNTLOG_TARGET_TYPE_GIVE = 2;
	int ACCOUNTLOG_TARGET_TYPE_GENERATE = 3;
	int ACCOUNTLOG_TARGET_TYPE_EXIT = 4;
	int ACCOUNTLOG_TARGET_TYPE_TAKE = 5;
	int ACCOUNTLOG_TARGET_TYPE_EXPIRE = 6;
	/**************** 体验金target_type end *************/

	/**
	 * 体验金账户日志target_name 对应操作类型【1：开户，2：发放，3：计息，4：（本金）退出，5：（收益）提取 6:过期】
	 */
	String ACCOUNTLOG_TARGET_NAME_OPENACCOUNT = "t_exp_account";
	String ACCOUNTLOG_TARGET_NAME_GIVE = "t_exp";
	String ACCOUNTLOG_TARGET_NAME_GENERATE = "t_interest_detail";
	String ACCOUNTLOG_TARGET_NAME_EXIT = "t_exp";
	String ACCOUNTLOG_TARGET_NAME_TAKE = "t_exp_out";
	String ACCOUNTLOG_TARGET_NAME_EXPIRE = "t_exp";
	/**************** 体验金target_name end *************/

	/**
	 * 体验金转出target_type 对应操作类型【1：开户，2：发放，3：计息，4：（本金）退出，5：（收益）提取 6:过期】
	 */
	int EXPOUT_TARGET_TYPE_ZLQ = 1;

	String EXPOUT_TARGET_NAME_ZLQ = "t_curlil_in";
	/**************** 体验金target_name end *************/
	
	/***************交易记录详情状态 start***************/
	public static String INVEST_CUR = "投资活期宝";
	public static String INVEST_CURLIL = "投资零钱";
	public static String INVEST_SUCCESS = "投资成功";
	public static String CURLIL_INVEST_CUR = "零钱投资活期宝";
	public static String CURLIL_AWARD = "零钱奖励";
	public static String WITHDRAW_APPLY="申请提现";
	public static String WITHDRAW_AUDIT_SUCCESS="提现审核成功"; 
	public static String WITHDRAW_AUDIT_FAILURE="提现审核失败";
	public static String WITHDRAW_UNDO="取消提现";
	public static String WITHDRAW_CANCEL="提现作废";
	public static String PAYING_FAILURE="打款失败";
	public static String PAYING_SUCCESS="打款成功";
	/***************交易记录详情状态 end***************/
	
	/*************账户 start************************/
	public static String OPEND_CURLIL_ACCOUNT_REMARK="零钱账户开户";
	public static String OPEND_CUR_ACCOUNT_REMARK="活期账户开户";
	
	/*************账户 end************************/
	
	/**************认证 start***************/
	public static Integer APPRO_TYPE_MOBILE=1;//手机认证
	public static Integer APPRO_TYPE_REALNAME=2;//实名认证
	public static String APPRO_MOBILE_REMARK="注册绑定手机号";
	public static Integer APPRO_WAIT_AUDIT=0;//待审核   
	public static Integer APPRO_PASS_AUDIT=1;//审核通过
	public static Integer APPRO_NOPASS_AUDIT=-1;//审核不通过
	/**************认证 end***************/

	/**************** 极光推送 start *************/
	String JPUSH_APP_KEY = "b11b59f7f3d74edf68bac70e";
	String JPUSH_MASTER_SECRET = "090fe14bca1363baf25d60ac";
