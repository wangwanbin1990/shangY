 ...
 * 使用说明：
 * 1、引入JS
 * 示例：<script type="text/javascript" src="${path }/js/formValid.js"></script>
 * 
...
Validator = {
	Require : /.+/,
	WordAndNum :/^(([A-Za-z]+[0-9]+)|([0-9]+[A-Za-z]+))[A-Za-z0-9]*$/i,
	WordOrNumOrChinese :/^[\u4e00-\u9fa5a-zA-Z0-9_\-【】：:\[\],，。.!！]+$/,
	Email : /^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/,
	Phone : /^0?(13|15|14|18|17)[0-9]{9}$/,
	...
	Range : "this.range(getAttribute('min'),getAttribute('max'),value)",//数值范围
